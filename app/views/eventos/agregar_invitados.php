		...
		<div class="card-body p-4">
			<form action="<?php echo URL_PATH; ?>invitacion/agregar" method="POST" enctype="multipart/form-data">
				...
				<div x-show="modo === 'manual'" x-transition>
					...
					<div class="row g-3">
						<div class="col-md-6"><label for="nombre_manual" class="form-label">Nombre Completo <span class="text-danger">*</span></label><input type="text" class="form-control" name="nombre_manual" id="nombre_manual"></div>
						<div class="col-md-6"><label for="email_manual" class="form-label">Correo Electrónico <span class="text-danger">*</span></label><input type="email" class="form-control" name="email_manual" id="email_manual"></div>
						<div class="col-md-6"><label for="telefono_manual" class="form-label">Teléfono (Opcional)</label><input type="tel" class="form-control" name="telefono_manual" id="telefono_manual"></div>
					</div>
				</div>
				...
				<div x-show="modo === 'csv'" x-transition>
					...
					<div class="alert alert-info d-flex justify-content-between align-items-center">
						<div>
							...
							<ul class="mb-0 small">
								<li>Columna 1: <strong>Nombre Completo</strong>, Columna 2: <strong>Email</strong>, Columna 3: <strong>Teléfono (Opcional)</strong></li>
